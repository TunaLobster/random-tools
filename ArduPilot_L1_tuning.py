...
l1damping_slider.on_changed(update)
l1period_slider.on_changed(update)
wpradius_slider.on_changed(update)
...
def reset(event):
    ...
    l1damping_slider.reset()
    l1period_slider.reset()
    wpradius_slider.reset()
